...
(function ($, document) {
    $.glisse = function (element, options) {
        ...
        var createElements = function createElements() {
            ...
            plugin.els['close']         = $(document.createElement('span')).attr('id','glisse-close').append($(document.createElement('a')).html('<i class="fa fa-times"></i>').attr("href", "#")).css(cssProp, cssVal);
            ...
            .append( $(document.createElement('a')).html('<i class="fa fa-angle-right"></i>').attr("href", "#"));
            ...
            .append($(document.createElement('a')).html('<i class="fa fa-angle-left"></i>').attr("href", "#"));
